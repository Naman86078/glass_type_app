...
plot_types = st.sidebar.multiselect("Select the chart : ",('Histogram', 'Box Plot', 'Count Plot', 'Pie Chart', 'Correlation Heatmap', 'Pair Plot'))



if 'Histogram' in plot_types:
  st.subheader("Histogram")
  columns = st.sidebar.selectbox("Select column to create the histogram : ",('RI', 'Na', 'Mg', 'Al', 'Si', 'K', 'Ca', 'Ba', 'Fe'))
  plt.figure(figsize=(12,8))
...
if 'Pie Chart' in plot_types:
  ...
  plt.pie(pie_data,labels=pie_data.index,explode=np.linspace(0.06,0.16,6),autopct='%1.2f%%')
  st.pyplot()
...
if 'Correlation Heatmap' in plot_types:
  ...
  bottum,top = ax.get_ylim()
  ax.set_ylim(bottum=+0.5,top=-0.5)
  st.pyplot()
...
st.sidebar.subheader("Chosse Classifer : ")
